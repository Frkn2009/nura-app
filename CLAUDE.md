...
4. No hardcoded colors — use `VoxelithTokens` (`core/theme/tokens.dart`) only.
...
- `VOXELITH_V14_HANDOFF_PACKET.md` — architecture handoff summary.
