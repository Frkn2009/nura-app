...
| 2 | RevenueCat panel kurulumu + AdMob gerçek anahtarlar | Kod tarafı hazır (`RevenueCatBillingService`) — kullanıcının panelde ürün/entitlement tanımlaması ve dart-define ile anahtarları geçmesi lazım, bkz. README |
