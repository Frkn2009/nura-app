...
| Plus konuşma COGS (cihaz STT + Flash + cihaz TTS) | 0.001 / dk |
| Plus konuşma COGS (bulut Maya sesi) | 0.012 / dk |

Hedef: Plus net gelirinin en fazla **%20**’si AI.  
1.490 TL/yıl ≈ \$37 (40 TRY/USD varsayım) → store %15 sonrası ≈ \$31.5 → AI bütçesi \$6.3/yıl ≈ 17 dk/gün ucuz yığın.

## Plus fiyat (vitrin)
- Aylık 249 TL
- Yıllık 1.490 TL (varsayılan)
- Aile 2.290 TL / 4 profil
