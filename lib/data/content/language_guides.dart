    ...
    for (final r in rules) {
      ...
      for (var part in parts) {
        part = part.replaceAll(
          RegExp(
            '[^a-zäöüßĳoeàáâãçèéêìíîñòóôõùúûýа-яα-ωก-๙ก-๛\u0600-\u06FF\u0590-\u05FF]+',
          ),
          '',
        );
...
final Map<LearnLang, LanguageGuide> _all = {
  LearnLang.en: LanguageGuide(
    ...
    intro:
        'İngilizce imla 500 yıllık kaza. Aynı harf beş ses olabilir. Türk için en kritik: th, w/v, ve schwa.',
    firstWeek:
        'th, w, schwa. Üçü oturursa Türkçe aksanlı İngilizce yarı yarıya iner.',
    rules: const [
      SoundRule(
        written: 'th',
        heard: 'dil diş arasında',
        example: 'think, the',
        exampleSaid: 'think (s değil) · dha',
        why: 'Türkçe s/z/t değil.',
      ),
      SoundRule(
        written: 'w vs v',
        heard: 'w = yuvarlak dudak · v = diş-dudak',
        example: 'west, vest',
        exampleSaid: 'uest · vest',
        why: 'Dudakları öne uzat.',
      ),
      SoundRule(
        written: 'schwa',
        heard: 'gevşek e',
        example: 'about, banana',
        exampleSaid: 'ebaut · benene',
        why: 'En sık ses. Zayıf heceyi yut.',
      ),
    ],
    traps: const [
  ...
  LearnLang.es: LanguageGuide(
    ...
    intro:
        'İspanyolca Türkçeden daha düzenli. Asıl iş: sessiz h, j\'nin hırıltısı.',
    ...
    rules: const [
      ...
      SoundRule(
        ...
        heard: 'kalın h',
        example: 'José, gente',
        exampleSaid: 'hose · hente',
        why: 'Türkçe c/j değil.',
      ),
      SoundRule(
        written: 'll',
        heard: 'y',
  ...
  LearnLang.de: LanguageGuide(
    ...
    rules: const [
      ...
      SoundRule(
        ...
        heard: 'ay',
        example: 'mein, nein',
        exampleSaid: 'mayn · nayn',
        why: 'ie\'nin tersi.',
      ),
      SoundRule(
        written: 'ch',
        heard: 'ich = ince hışırtı · ach = kalın',
        example: 'ich, Bach',
        exampleSaid: 'ih · bah',
        why: 'Türkçe ç değil.',
      ),
  ...
  LearnLang.fr: LanguageGuide(
    ...
    rules: const [
      ...
      SoundRule(
        ...
        example: 'tu, rue',
        exampleSaid: 'tü · rü',
        why: 'Dudaklar ü, dil i.',
      ),
      SoundRule(
        written: 'son sessizler',
        heard: 'çoğu susar',
        example: 'petit, tard',
        exampleSaid: 'pöti · tar',
        why: 't, d, s kelime sonunda ölü.',
      ),
    ],
    traps: const [
  ...
  LearnLang.nl: LanguageGuide(
    ...
    rules: const [
      ...
      SoundRule(
        ...
        heard: 'ö (Türkçe göl)',
        example: 'leuk, kleur',
        exampleSaid: 'lök · klör',
        why: 'Yuvarlak ön ünlü.',
      ),
      SoundRule(
        written: 'ui',
        heard: 'öy',
        example: 'huis, uit',
        exampleSaid: 'höys · öyt',
        why: 'Kayan iki ses.',
      ),
    ],
    traps: const [
  ...
  LearnLang.ar: LanguageGuide(
    ...
    rules: const [
      ...
      SoundRule(
        written: 'ق',
        heard: 'kalın k (gırtlak)',
        example: 'قهوة',
        exampleSaid: 'qahwa',
        why: 'Türkçe k\'den daha geride.',
      ),
    ],
    traps: const [
  ...
  LearnLang.pt: LanguageGuide(
    ...
    intro:
        'ão, ões gibi burun sesleri Portekizce\'nin imzası. nh = ny, lh = ly.',
    ...
    rules: const [
      ...
      SoundRule(
        ...
        example: 'vinho',
        exampleSaid: 'vinyu',
        why: 'İspanyolca ñ gibi.',
      ),
      SoundRule(
        written: 'lh',
        heard: 'ly',
        example: 'trabalho',
        exampleSaid: 'trabaylu',
        why: 'ly sesi.',
      ),
    ],
    traps: const [
  ...
  LearnLang.it: LanguageGuide(
    ...
    intro:
        'İtalyanca Türkçe gibi okunur. Asıl fark: çift harfler gerçekten uzun söylenir.',
    ...
    rules: const [
      ...
      SoundRule(
        ...
        heard: 'uzun ses',
        example: 'notte, pizza',
        exampleSaid: 'not-te · pit-tsa',
        why: 'Kısa söylersen anlam değişir.',
      ),
    ],
    traps: const [
  ...
  LearnLang.ru: LanguageGuide(
    ...
    intro:
        'Kiril harfleri öğrenince okuma kolay. Vurgu yerine göre sesli değişir.',
  ...
  LearnLang.zh: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        written: '4 ton',
        heard: 'düz/yükselen/alçalıp-yükselen/düşen',
        example: 'mā má mǎ mà',
        exampleSaid: 'anne · kenevirr · at · azarlamak',
        why: 'Ton = anlam.',
      ),
      SoundRule(
        written: 'zh',
        heard: 'c (dil geriye)',
        example: '中国',
        exampleSaid: 'cong-guo',
        why: 'Türkçe c\'ye yakın.',
      ),
      SoundRule(
        written: 'x',
        heard: 'ince s',
        example: '谢谢',
        exampleSaid: 'syeh-syeh',
        why: 's ve ş arası.',
      ),
    ],
    traps: const [
  ...
  LearnLang.ja: LanguageGuide(
    ...
    intro:
        'Hiragana, Katakana ve Kanji. Sesler Türkçe\'ye yakın ama uzun/kısa ünlü önemli.',
    firstWeek: 'Hiragana öğren. Uzun ünlüyü uzat. す su bazen sessiz.',
    rules: const [
      SoundRule(
        written: 'uzun ünlü',
        heard: 'anlam değiştirir',
        example: 'おばさん vs おばあさん',
        exampleSaid: 'obasan · obaasan',
        why: 'Teyze vs büyükanne.',
      ),
      SoundRule(
        written: 'r',
        heard: 'l ve r arası',
  ...
  LearnLang.ko: LanguageGuide(
    ...
    intro:
        'Hangul öğrenilmesi en kolay alfabelerden. Sesler blok halinde yazılır.',
  ...
  LearnLang.tr: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        ...
        heard: 'uzatma / yok',
        example: 'dağ, değil',
        exampleSaid: 'daa · deyil',
        why: 'Harf var ama ses neredeyse yok.',
      ),
      SoundRule(
        written: 'ı vs i',
        heard: 'kalın ı / ince i',
        example: 'kız, kiz',
        exampleSaid: 'kız · kiz',
        why: 'İngilizce i yok, iki ayrı ses.',
      ),
      SoundRule(
        written: 'c',
        heard: 'c = Türkçe c',
  ...
  LearnLang.sv: LanguageGuide(
    ...
    rules: const [
      ...
      SoundRule(
        ...
        heard: 'ç sesi',
        example: 'kör, kilo',
        exampleSaid: 'çör · çilo',
        why: 'Ön ünlülerle k → ç.',
      ),
    ],
    traps: const [
  ...
  LearnLang.da: LanguageGuide(
    ...
    intro:
        'Danca yazısı İsveççe\'ye benzer ama telaffuz çok farklı. Stød = gırtlak durağı.',
    firstWeek: 'Stød\'ü duy. d çoğu zaman yumuşar. å=o.',
    rules: const [
      SoundRule(
        written: 'd (yumuşak)',
        heard: 'ð veya yutulur',
        example: 'mad, god',
        exampleSaid: 'mað · goð',
        why: 'd → th veya kaybolur.',
      ),
      SoundRule(
        written: 'stød',
        heard: 'gırtlak durağı',
        example: 'hun, hund',
        exampleSaid: 'hun · hunˀ',
        why: 'Kısa gırtlak kapanması.',
      ),
      SoundRule(
        written: 'å',
        heard: 'o',
  ...
  LearnLang.fi: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        written: 'çift harf',
        heard: 'uzun ses',
        example: 'tuli vs tuuli',
        exampleSaid: 'tuli · tuuli',
        why: 'Ateş vs rüzgar.',
      ),
      SoundRule(
        written: 'ä',
  ...
  LearnLang.cs: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        ...
        heard: 'titreşimli rj',
        example: 'řeka, Dvořák',
        exampleSaid: 'rjeka · dvorjak',
        why: 'Dünyada tek. Dili titret + j.',
      ),
      SoundRule(
        written: 'š',
        heard: 'ş',
  ...
  LearnLang.hi: LanguageGuide(
    ...
    intro:
        'Devanagari fonetik bir alfabe. Aspirasyonlu/aspirasyonsuz çiftler önemli.',
    ...
    rules: const [
      SoundRule(
        ...
        heard: 'k vs kh',
        example: 'कम, खाना',
        exampleSaid: 'kam · khaana',
        why: 'Nefesli/nefessiz.',
      ),
      SoundRule(
        written: 'retroflex',
        heard: 'dili geriye kıvır',
        example: 'ट, ड',
        exampleSaid: 'ṭ · ḍ',
        why: 'İngilizce t/d\'den farklı.',
      ),
      SoundRule(
        written: 'anusvara ं',
        heard: 'burun sesi',
  ...
  LearnLang.th: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        written: '5 ton',
        heard: 'orta/alçak/düşen/yüksek/yükselen',
        example: 'ไหม/ไม่/ใหม่',
        exampleSaid: 'may? · may! · may(yeni)',
        why: 'Ton = anlam.',
      ),
      SoundRule(
        written: 'aspirasyon',
        heard: 'p/ph, t/th, k/kh',
        example: 'พ่อ vs ป่า',
        exampleSaid: 'phɔɔ · paa',
        why: 'Nefesli çift.',
      ),
      SoundRule(
        written: 'r vs l',
        ...
        example: 'ร, ล',
        exampleSaid: 'r · l',
        why: 'Konuşma dilinde r→l olabilir.',
      ),
    ],
    traps: const [
  ...
  LearnLang.vi: LanguageGuide(
    ...
    rules: const [
      SoundRule(
        written: '6 ton',
        heard: '6 farklı melodi',
        example: 'ma, má, mà, mả, mã, mạ',
        exampleSaid: 'altı farklı anlam',
        why: 'Her ton farklı kelime.',
      ),
      SoundRule(
        written: 'ơ',
        heard: 'ı/ö arası',
  ...
  LearnLang.id: LanguageGuide(
    ...
    intro:
        'Endonezce Latin harfli, fonetik, çekim yok. Ön/son eklerle kelime türetilir.',
  ...
  LearnLang.he: LanguageGuide(
    ...
    intro:
        'İbranice sağdan sola yazılır. Sesli harfler genelde yazılmaz (nikkud hariç).',
  ...
  LearnLang.fa: LanguageGuide(
    ...
    intro:
        'Farsça Arap harfleri kullanır ama gramer çok farklı. پ چ ژ گ Farsça\'ya özel.',
  ...
  LearnLang.sw: LanguageGuide(
    ...
    intro:
        'Svahili Latin harfli, fonetik. Sınıf sistemi (m-, wa-, ki-, vi- gibi ön ekler) ana kural.',
