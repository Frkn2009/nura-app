...
class OfflineTranslate {
  ...
  static const List<Map<LearnLang, String>> _dictionary = [
    ...
    {
      LearnLang.en: 'yes', LearnLang.es: 'sí', LearnLang.de: 'ja',
      LearnLang.fr: 'oui', LearnLang.nl: 'ja', LearnLang.ar: 'نعم',
      LearnLang.pt: 'sim', LearnLang.it: 'sì', LearnLang.ru: 'да',
      LearnLang.zh: '是', LearnLang.ja: 'はい', LearnLang.ko: '네',
      LearnLang.tr: 'evet', LearnLang.pl: 'tak', LearnLang.sv: 'ja',
      LearnLang.da: 'ja', LearnLang.no: 'ja', LearnLang.fi: 'kyllä',
      LearnLang.el: 'ναι', LearnLang.cs: 'ano', LearnLang.ro: 'da',
      LearnLang.hu: 'igen', LearnLang.hi: 'हाँ', LearnLang.th: 'ใช่',
      LearnLang.vi: 'vâng', LearnLang.id: 'ya', LearnLang.uk: 'так',
      LearnLang.he: 'כן', LearnLang.fa: 'بله', LearnLang.sw: 'ndiyo',
    },
    {
      LearnLang.en: 'no', LearnLang.es: 'no', LearnLang.de: 'nein',
      LearnLang.fr: 'non', LearnLang.nl: 'nee', LearnLang.ar: 'لا',
      LearnLang.pt: 'não', LearnLang.it: 'no', LearnLang.ru: 'нет',
      LearnLang.zh: '不', LearnLang.ja: 'いいえ', LearnLang.ko: '아니요',
      LearnLang.tr: 'hayır', LearnLang.pl: 'nie', LearnLang.sv: 'nej',
      LearnLang.da: 'nej', LearnLang.no: 'nei', LearnLang.fi: 'ei',
      LearnLang.el: 'όχι', LearnLang.cs: 'ne', LearnLang.ro: 'nu',
      LearnLang.hu: 'nem', LearnLang.hi: 'नहीं', LearnLang.th: 'ไม่',
      LearnLang.vi: 'không', LearnLang.id: 'tidak', LearnLang.uk: 'ні',
      LearnLang.he: 'לא', LearnLang.fa: 'نه', LearnLang.sw: 'hapana',
    },
    {
      LearnLang.en: 'coffee', LearnLang.es: 'café', LearnLang.de: 'kaffee',
      LearnLang.fr: 'café', LearnLang.nl: 'koffie', LearnLang.ar: 'قهوة',
      LearnLang.pt: 'café', LearnLang.it: 'caffè', LearnLang.ru: 'кофе',
      LearnLang.zh: '咖啡', LearnLang.ja: 'コーヒー', LearnLang.ko: '커피',
      LearnLang.tr: 'kahve', LearnLang.pl: 'kawa', LearnLang.sv: 'kaffe',
      LearnLang.da: 'kaffe', LearnLang.no: 'kaffe', LearnLang.fi: 'kahvi',
      LearnLang.el: 'καφές', LearnLang.cs: 'káva', LearnLang.ro: 'cafea',
      LearnLang.hu: 'kávé', LearnLang.hi: 'कॉफ़ी', LearnLang.th: 'กาแฟ',
      LearnLang.vi: 'cà phê', LearnLang.id: 'kopi', LearnLang.uk: 'кава',
      LearnLang.he: 'קפה', LearnLang.fa: 'قهوه', LearnLang.sw: 'kahawa',
    },
    {
      LearnLang.en: 'tea', LearnLang.es: 'té', LearnLang.de: 'tee',
      LearnLang.fr: 'thé', LearnLang.nl: 'thee', LearnLang.ar: 'شاي',
      LearnLang.pt: 'chá', LearnLang.it: 'tè', LearnLang.ru: 'чай',
      LearnLang.zh: '茶', LearnLang.ja: 'お茶', LearnLang.ko: '차',
      LearnLang.tr: 'çay', LearnLang.pl: 'herbata', LearnLang.sv: 'te',
      LearnLang.da: 'te', LearnLang.no: 'te', LearnLang.fi: 'tee',
      LearnLang.el: 'τσάι', LearnLang.cs: 'čaj', LearnLang.ro: 'ceai',
      LearnLang.hu: 'tea', LearnLang.hi: 'चाय', LearnLang.th: 'ชา',
      LearnLang.vi: 'trà', LearnLang.id: 'teh', LearnLang.uk: 'чай',
      LearnLang.he: 'תה', LearnLang.fa: 'چای', LearnLang.sw: 'chai',
    },
    {
      LearnLang.en: 'toilet', LearnLang.es: 'baño', LearnLang.de: 'toilette',
      LearnLang.fr: 'toilettes', LearnLang.nl: 'toilet', LearnLang.ar: 'حمام',
      LearnLang.pt: 'banheiro', LearnLang.it: 'bagno', LearnLang.ru: 'туалет',
      LearnLang.zh: '厕所', LearnLang.ja: 'トイレ', LearnLang.ko: '화장실',
      LearnLang.tr: 'tuvalet', LearnLang.pl: 'toaleta', LearnLang.sv: 'toalett',
      LearnLang.da: 'toilet', LearnLang.no: 'toalett', LearnLang.fi: 'vessa',
      LearnLang.el: 'τουαλέτα', LearnLang.cs: 'toaleta', LearnLang.ro: 'toaletă',
      LearnLang.hu: 'mosdó', LearnLang.hi: 'शौचालय', LearnLang.th: 'ห้องน้ำ',
      LearnLang.vi: 'nhà vệ sinh', LearnLang.id: 'toilet', LearnLang.uk: 'туалет',
      LearnLang.he: 'שירותים', LearnLang.fa: 'توالت', LearnLang.sw: 'choo',
    },
    {
      LearnLang.en: 'where', LearnLang.es: 'dónde', LearnLang.de: 'wo',
      LearnLang.fr: 'où', LearnLang.nl: 'waar', LearnLang.ar: 'أين',
      LearnLang.pt: 'onde', LearnLang.it: 'dove', LearnLang.ru: 'где',
      LearnLang.zh: '哪里', LearnLang.ja: 'どこ', LearnLang.ko: '어디',
      LearnLang.tr: 'nerede', LearnLang.pl: 'gdzie', LearnLang.sv: 'var',
      LearnLang.da: 'hvor', LearnLang.no: 'hvor', LearnLang.fi: 'missä',
      LearnLang.el: 'πού', LearnLang.cs: 'kde', LearnLang.ro: 'unde',
      LearnLang.hu: 'hol', LearnLang.hi: 'कहाँ', LearnLang.th: 'ที่ไหน',
      LearnLang.vi: 'ở đâu', LearnLang.id: 'di mana', LearnLang.uk: 'де',
      LearnLang.he: 'איפה', LearnLang.fa: 'کجا', LearnLang.sw: 'wapi',
    },
  ];
}
