...
/// SRS kart durumu (FSRS state makinesi).
enum SrsCardState {
  newCard,
  learning,
  review,
...
/// Kalıcı SRS kartı. **`phrase` alanı YOKTUR** (içerikten bağımsız, sadece
/// algoritma durumu). JSON'a serileşebilir; Hive/SharedPreferences uyumlu.
@immutable
class SrsCard {
  const SrsCard({
    required this.id,
