...
class FamilyProfilesScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: VoxelithAppBar(pageTitle: const Text('Aile profilleri')),
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Text(
              ...
              style: TextStyle(color: Voxelith.muted, height: 1.4),
            ),
  ...
  Widget _profileCard(
    ...
    color: selected ? Voxelith.mintLight : null,
    onTap: selected
        ? null
        : () => ref
    ...
    child: Row(
      children: [
        CircleAvatar(
          radius: 24,
          backgroundColor: selected ? Voxelith.mintDark : Voxelith.cloud,
          child: Text(
            profile.profileName.characters.first.toUpperCase(),
            style: TextStyle(
              color: selected ? Colors.white : Voxelith.ink,
        ...
        if (selected)
          const Icon(Icons.check_circle, color: Voxelith.mintDark)
          ...
          IconButton(
            ...
            icon: const Icon(Icons.delete_outline, color: Voxelith.soft),
          ),
      ],
    ),
  );
