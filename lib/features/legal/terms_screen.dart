...
class TermsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: NuraAppBar(pageTitle: const Text('Kullanım Koşulları')),
      body: ListView(
        padding: const EdgeInsets.fromLTRB(22, 12, 22, 32),
        children: const [
          Text(
            'NURA Kullanım Koşulları',
            style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700),
          ),
          SizedBox(height: 12),
          Text(
            'NURA Plus ve NURA Business abonelikleri, seçtiğin süre için '
            ...
            'yönetilir — NURA içinden değil, çünkü ödemeyi mağaza alır.\n\n'
            ...
            'Sorular için: destek@nura.app (yer tutucu — domain '
